...
source.exclude_patterns = */test/*,*.pyc,*.pyo
...
requirements = python3==3.10.8,kivy==2.2.1,android,pyjnius
...
# 3) A directory or file to add to the default resources location.
